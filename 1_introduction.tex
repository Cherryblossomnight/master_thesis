...
In the current literatures, the aerial robots are require to solve the manipulation tasks like bridge inspection \cite{bodie_2020_active}, writing \cite{guo_2024_flying}, and. Apparently, the requirements in reality of surface sliding tasks are very high.
