...
We can briefly divide the morphologies of aerial manipulation into four types: single rigid body manipulator, parrel manipulator, series manipulator and other specific type like multi-link aerial robot. The structure is important for aerial manipulation as illustrated in Fig.~\ref{fig:morphologies}. Until now, the tranditional morphologies have been used in the surface sliding tasks.
...
%Therefore, the control method for the single rigid body manipulator has developed a lot. 
Generally, the rigid manipulator is used for task like push-and-slide and peg-in-hole. 
