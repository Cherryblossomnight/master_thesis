...
\begin{figure}[!htbp]
    ...
    \caption{Tracking trajectory on the board. (a) Baseline PD controller. (b) Only impedance controller. (c) Only admittance controller. (d) Hybrid impedance-admittance controller.}
...
\begin{figure}[!htbp]
    ...
    \caption{Circle trajectory tracking result of the CoG under four controllers. (a) Baseline PD controller. (b) Only impedance controller. (c) Only admittance controller. (d) Hybrid impedance-admittance controller.}
...
\begin{figure}[!htbp]
    ...
    \caption{Circle trajectory tracking result of the CoG under four controllers. (a) Baseline PD controller. (b) Only impedance controller. (c) Only admittance controller. (d) Hybrid impedance--admittance controller. The yellow region denotes the contacting period. }
