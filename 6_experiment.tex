...
\begin{figure}[!htbp]
    ...
    \caption{The plot of the dragging experiment.}
...
Fig.~\ref{fig:admittance_deformation_plot} shows the relationship between the external force and the joints angle. In the pink region when the admittance controller is activated and the multi-link aerial robot is dragged to the negative direction of $x$ axis, the plot shows that the external force estimated in the $x$ axis appears apparent negative value, and the joints angle value also changes to deformation according to the admittance controller.
...
\begin{figure}[!htbp]
    ...
    \caption{Plot of external force on the CoG in the $x$ axis and joint angle variation. The yellow region denotes the admittance controller activing period, and the pink region indicates the interval the aerial is being dragged by the rope.}
